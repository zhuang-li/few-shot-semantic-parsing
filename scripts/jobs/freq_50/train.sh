...
data_dir="datasets/jobs/query_split/freq_50/few_shot_split_random_3_predi/shuffle_${shuffle}_shot_${k_shot_num}/"
model_dir="saved_models/jobs/query_split/freq_50/few_shot_split_random_3_predi/shuffle_${shuffle}_shot_${k_shot_num}/"
