...
if [[ $white_list -eq 0 ]]
then
  data_dir_prefix="datasets/jobs/query_split/supervised/few_shot_split_random_3_predi/"
  model_dir_prefix="saved_models/jobs/query_split/supervised/few_shot_split_random_3_predi/"
elif [[ $white_list -eq 1 ]]
then
  data_dir_prefix="datasets/jobs/query_split/supervised/no_use_white_list/few_shot_split_random_3_predi/"
  model_dir_prefix="saved_models/jobs/query_split/supervised/no_use_white_list/few_shot_split_random_3_predi/"
fi
...
. scripts/jobs/comb_train/test.sh ${model_dir}${model_name}.bin ${shuffle} ${k_shot_num} ${white_list}
