...
k_shot_num=$3
suffix=$4
data_dir="datasets/geo/freq_50/shuffle_${shuffle}_shot_${k_shot_num}/"
model_dir="saved_models/geo/freq_50/shuffle_${shuffle}_shot_${k_shot_num}/"
...
. scripts/geo/two_shot/test.sh ${model_dir}${fine_model_name}.bin ${shuffle} ${k_shot_num} ${suffix}
