...
k_shot_num=$3
suffix=$4
data_dir="datasets/geo/lambda/query_split/unnorm/few_shot_split_random_5_predi/shuffle_${shuffle}_shot_${k_shot_num}/"
model_dir="saved_models/geo/lambda/query_split/unnorm/few_shot_split_random_5_predi/shuffle_${shuffle}_shot_${k_shot_num}/"
...
. scripts/geo/lambda/query_split/dropout_proto_few_shot/test.sh ${model_dir}${fine_model_name}.bin ${shuffle} ${k_shot_num} ${suffix}
