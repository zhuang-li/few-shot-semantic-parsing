...
shuffle=$1
k_shot_num=$2
vocab="datasets/geo/supervised/shuffle_${shuffle}_shot_${k_shot_num}/vocab.freq2.bin"
train_file="datasets/geo/supervised/shuffle_${shuffle}_shot_${k_shot_num}/train.bin"
dropout=0.5
dropout_i=0
hidden_size=256
embed_size=128
...
python -u sup_exp.py \
    ...
    --log_every 50 \
    --save_to saved_models/geo/lambda/query_split/seq2seq_tranx/${model_name} \
    #--dev_file datasets/jobs/test.bin \
    #2>logs/geo/question_split/question_split/${model_name}.log

. scripts/geo/lambda/query_split/seq2seq_tranx/test.sh saved_models/geo/lambda/query_split/seq2seq_tranx/${model_name}.bin ${shuffle} ${k_shot_num}
