...
data_dir="datasets/atis/query_split/unnorm/few_shot_split_random_5_predi/shuffle_${shuffle}_shot_${k_shot_num}/"
model_dir="saved_models/atis/query_split/unnorm/few_shot_split_random_5_predi/shuffle_${shuffle}_shot_${k_shot_num}/"
