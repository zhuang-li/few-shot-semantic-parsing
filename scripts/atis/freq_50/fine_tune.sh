...
k_shot_num=$3
suffix=$4
data_dir="datasets/atis/query_split/freq_50/few_shot_split_random_5_predi/shuffle_${shuffle}_shot_${k_shot_num}/"
model_dir="saved_models/atis/query_split/freq_50/few_shot_split_random_5_predi/shuffle_${shuffle}_shot_${k_shot_num}/"
